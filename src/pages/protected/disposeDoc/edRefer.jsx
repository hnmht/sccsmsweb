...
import { reqReferED } from "../../../api/executeDoc";
import { columns } from "./edConstructor";

const EDRefer = ({ title, conditions, cancelClickAction, okClickAction, filterAction }) => {
